...
<tr>
    <th>見出し</th>
    <td style="max-width: 250px;">
        <?=nl2br(h($input->jra_thisweek_horse_26_title))?>&nbsp;
        <?php HTPrint::Hidden('jra_thisweek_horse_26_title',$input->jra_thisweek_horse_26_title); ?>
    </td>
</tr>
<tr>
    <th>本文</th>
    <td style="max-width: 250px;">
        <?=nl2br(h($input->jra_thisweek_horse_26_1))?>&nbsp;
        <?php HTPrint::Hidden('jra_thisweek_horse_26_1',$input->jra_thisweek_horse_26_1); ?>
    </td>
</tr>
