        ...
        <td>
            <?php
                $list=[
                    ...
                    !$data->has_jra_thisweek_26?'':(new MkTagA('記',InAppUrl::to('race/j_thisweek_26.php',['race_id'=>$race->race_id,'show_registration_only'=>($race_url_add_param?true:null)])))->title("今週の注目レース"),
                    !$data->has_jra_thisweek_25?'':(new MkTagA('記',InAppUrl::to('race/j_thisweek.php',['race_id'=>$race->race_id,'show_registration_only'=>($race_url_add_param?true:null)])))->title("今週の注目レース(2025以前型式)"),
                ]
            ?>
