...
class SyutsubaTableGetter {
    ...
    public function getSyutsubaData(object $race, int $rr_count=4){
        # このレース情報取得
        $sql = (function(){
        ...
        $horse_id='';
        $stmt2 = $this->pdo->prepare($result_get_sql);
        ...
        $rr12HourseGetter=new RaceResults1stOr2ndHourseGetter($this->pdo);
