...
$race_category_age_table=new RaceCategoryAge();
$race_category_age = $race_category_age_table->getPage($pdo,$search_page,$show_disabled);
?><!DOCTYPE html>
<html lang="ja">
<head>
