...
if($input_id>0){
    $form_item=Jockey::getById($pdo,$input_id);
    if($form_item!==false){
        $page->title.="（編集）";
    }else{
        $input_id=0;
...
<tr>
    <td>レース結果の騎手名がキー名称と一致すると<br>略名などを適用します。</td>
</tr>
<?php endif; ?>
<!--
<tr>
...
<tr>
    <th>厩舎</th>
    <td class="in_input"><input type="text" name="trainer_name" value="<?=h($form_item->trainer_name)?>" placeholder="厩舎"></td>
</tr>
<tr>
    <th>匿名</th>
    <td>
