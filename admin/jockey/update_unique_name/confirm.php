...
$page->title="騎手マスタ管理｜キー名称の一括変更：確認";
$page->ForceNoindex();
$session=new Session();
...
<?php $new_id_exists=$updater->new_id_exists(Jockey::TABLE,'unique_name'); ?>
<?php if($new_id_exists): ?>
新名称[<?=h($new_unique_name)?>]の騎手は既にマスタに存在します。<br>
マスタの名称は変更せず、旧名称のレース結果を新名称で指定した騎手に紐づけます。
<?php endif; ?>
